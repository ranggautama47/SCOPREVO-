<template>
  <section class="bg-[#1A1A1A] py-16 md:py-24 px-4 md:px-8">
    <div class="max-w-[1200px] mx-auto text-center flex flex-col items-center gap-8">
      <!-- Headline -->
      <h2 class="font-['Baskervville',serif] text-4xl md:text-5xl lg:text-6xl leading-[1.1] text-[#FAFAF9] max-w-2xl">
        Stop guessing what's in scope.
      </h2>

      <!-- Subtext -->
      <p class="font-['Noto_Serif',serif] text-lg leading-[1.7] text-[#FAFAF9]/75 max-w-xl">
      ...
      <a
        ...
        aria-label="Get started with SCOPREVO"
      >
        GET STARTED
